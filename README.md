...
- **🔌 PicoClaw RPI Agent Integration** - High-speed bidirectional bridge via WebSockets using the Native Pico Protocol. Connects to the PicoClaw agentic AI on external Raspberry Pi hardware (192.168.1.60) for long-reasoning delegation, hardware control, and local RPI tool execution.
