...
func Set_tool_weather_hints() {
	SetPromptHints("tool_weather", &PromptHintsConfig{
		...
		PromptText:    "☁️ FOR WEATHER TASKS: Use 'tool_weather'. Provide 'lat', 'lon' (default 46.2836, 6.6444 for Col de Corbier), and 'tz' (default Berlin). 🚨 CRITICAL: Format the final response with bold headers, emojis, and clear bullet points to be highly readable on Telegram.",
		ForceToolCall: true,
